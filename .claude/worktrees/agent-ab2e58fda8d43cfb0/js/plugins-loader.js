...
(function () {
  ...
  function apiBase() {
    ...
    let base = meta?.content ? meta.content.replace(/\/+$/, '') : '/painel-php/api';
    // Dev local: portal em :8000, painel Node em :3000
    if (base.startsWith('/') && location.hostname === 'localhost' && location.port === '8000') {
